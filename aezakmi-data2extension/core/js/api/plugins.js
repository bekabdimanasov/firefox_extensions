  ...
  async onPageCreated(page) {
    await page.evaluateOnNewDocument(() => {
      function mockPluginsAndMimeTypes() {
          ...
          mimeTypes: [
            {
              ...
              suffixes: '',
              description: '',
              __pluginName: 'News feed handler'
            },
            {
              type: 'application/pdf',
              suffixes: 'pdf',
              description: '',
              __pluginName: 'Chromium PDF Viewer'
            },
            {
            ...
            },
            {
              ...
              suffixes: 'pdf',
              description: 'Portable Document Format',
              __pluginName: 'Chromium PDF Plugin'
            }
          ],
          plugins: [
            {
            ...
            },
            {
              ...
              filename: 'enmlgamfkfdemjmlfjeeipglcfpomikn',
              description: ''
            }
          ],
          fns: {
        ...
        const fakeDataSafari = {
          mimeTypes: [
            {
              type: 'application/postscript',
              suffixes: 'ps',
              description: 'PostScript',
              __pluginName: 'WebKit built-in PDF'
            },
            {
              type: 'text/pdf',
              suffixes: 'pdf',
        ...
        if (isChrome()) {
          const fakeData = fakeDataChrome;
        }
        if (isFirefox()) {
          const fakeData = fakeDataFirefox;
        }
        if (isOpera()) {
          const fakeData = fakeDataOpera;
        }
        if (isSafari()) {
          const fakeData = fakeDataSafari;
        }
